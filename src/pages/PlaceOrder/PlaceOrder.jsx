            ...
            <div className="place-order-right">
                <div className="cart-total">
                    ...
                    <div>
                        ...
                        <hr />
                        <div className="cart-total-details"> <p className={getTotalCartAmount() >= 500 ? 'strikethrough' : ''}>Delivery Fee</p>
                        <p>&#8377; {getTotalCartAmount() === 0 ? 0 : (getTotalCartAmount() < 500 ? 50 : 0)}</p></div>
                        <hr />
                        <div className="cart-total-details"><b>Total</b><b>&#8377;  {getTotalCartAmount() === 0 ? 0 : (getTotalCartAmount() < 500 ? getTotalCartAmount() + 50 : getTotalCartAmount())}</b></div>
                    </div>
                </div>
